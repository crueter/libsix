...
public class SixCurrentConfigs {
    /**
     ...
     */
    public SixCurrentConfigs withNeutralDeadband(double neutralDeadband) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixCurrentConfigs withPeakForwardOutput(double peakForwardOutput) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixCurrentConfigs withPeakReverseOutput(double peakReverseOutput) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixCurrentConfigs withClosedRampPeriod(double closedRampPeriod) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixCurrentConfigs withOpenRampPeriod(double openRampPeriod) {
