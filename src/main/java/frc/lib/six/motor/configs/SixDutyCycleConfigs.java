...
public class SixDutyCycleConfigs {
    /**
     ...
     */
    public SixDutyCycleConfigs withNeutralDeadband(double neutralDeadband) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixDutyCycleConfigs withPeakForwardOutput(double peakForwardOutput) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixDutyCycleConfigs withPeakReverseOutput(double peakReverseOutput) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixDutyCycleConfigs withClosedRampPeriod(double closedRampPeriod) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixDutyCycleConfigs withOpenRampPeriod(double openRampPeriod) {
