 ...
 */
public class SixCurrentLimitConfigs {
    /**
     ...
     */
    public SixCurrentLimitConfigs withSupplyCurrentLimit(double supplyCurrentLimit) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixCurrentLimitConfigs withSupplyCurrentThreshold(double supplyCurrentThreshold) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixCurrentLimitConfigs withSupplyTimeThreshold(double supplyTimeThreshold) {
     ...
     * @return Itself, with this parameter changed.
     */
    public SixCurrentLimitConfigs withStatorCurrentLimit(double statorCurrentLimit) {
