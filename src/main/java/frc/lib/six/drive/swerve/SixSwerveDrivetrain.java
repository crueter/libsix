...
import frc.lib.six.drive.swerve.requests.SixChassisSpeedsDrive;
import frc.lib.six.drive.swerve.requests.SixSwerveIdle;
import frc.lib.six.drive.swerve.requests.SixSwerveRequest;
import frc.lib.six.drive.swerve.requests.SixSwerveRequest.SwerveControlRequestParameters;
import frc.lib.six.gyro.SixGyro;

/** Generic Swerve Drivetrain subsystem. */
public class SixSwerveDrivetrain extends SixDrivetrain {
    /**
     * <p>
     ...
     */
    protected List<SixSwerveModule> m_modules = new ArrayList<SixSwerveModule>();
    ...
    protected SixSwerveSim m_simDrive;
    ...
    public void setup(SixSwerveModule... modules) {
        ...
        // m_simDrive = new SixSwerveSim(getModuleLocations(), (SixV6Pigeon2) m_gyro, m_config, m_modules);
     ...
     * 
     * @param request The {@link SixSwerveRequest} to apply.
     */
    public void setControl(SixSwerveRequest request) {
    ...
    public void resetEncoders() {
        for (SixSwerveModule module : m_modules) {
