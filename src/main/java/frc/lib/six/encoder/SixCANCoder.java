...
/** SixLib implementation of the CTRE CANCoder. */
public class SixCANCoder extends CANcoder implements SixAbsoluteEncoder {
    CANcoderConfigurator m_configurator;

    public SixCANCoder(int port) {
        this(port, "");
    }

    public SixCANCoder(int port, String canBus) {
        super(port, canBus);
