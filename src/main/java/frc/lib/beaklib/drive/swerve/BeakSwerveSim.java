...
public class BeakSwerveSim {
    ...
    public BeakSwerveSim(Translation2d[] wheelLocations,
                               Pigeon2 pigeon,
                               DrivetrainConfiguration driveConstants,
                                List<BeakSwerveModule> modules) {
     ...
     */
    public void update(double dtSeconds, double supplyVoltage, List<BeakSwerveModule> modulesToApply) {
